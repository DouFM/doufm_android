...
public class Constants {
    ...
    public static String[] mActionBarColors = {"#607d8b", "#ff5722", "#795548",
            ...
            "#607d8b"};
    public static String[] mBackgroundColors = {"#90a4ae", "#ff8a65", "#a1887f",
            ...
            "#90a4ae"};
    public static String[] mCotrolBackgroundColors = {"#cfd8dc", "#ffccbc", "#d7ccc8",
